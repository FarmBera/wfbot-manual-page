    ...
    content: (
      <div className="space-y-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          {APP_INFO.name} 가이드에 오신 것을 환영합니다
        </h1>
        <p className="text-gray-600 leading-relaxed">
          이 문서는 <strong>{APP_INFO.name}</strong>의 설치부터 고급 기능
          활용까지 모든 내용을 담고 있습니다. 왼쪽의 목차를 통해 원하는 정보로
          빠르게 이동할 수 있습니다.
        </p>
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mt-4">
          <p className="text-sm text-blue-700">
            <strong>참고:</strong> 이 문서는 최신 버전({APP_INFO.version})을
            기준으로 작성되었습니다.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="border p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-sm text-gray-500">
              새로운 워프레임 컨텐츠가 올라온다면 실시간으로 알려줍니다.
              <br />
  ...
  // legal / EULA
  {
    ...
    content: (
      <div className="space-y-4 text-sm text-gray-500">
        ...
        <p>
          본 소프트웨어의 저작권은 {APP_INFO.company}에 있습니다. 무단 복제 및
