    ...
    id: "faq", title: "자주 묻는 질문 (FAQ)", list: [// 상호작용 오류
        ...
        </>)},*/
      {
        q: "봇을 개인 서버에 추가하고 싶어요", a: (<>
          추가 가능합니다!<br/>
          우측 사용자 목록에서 고양이 프라임 봇을 찾아 '앱 추가하기' 버튼을 눌러서 개인 서버에 추가할 수 있습니다.<br/><br/>
          단, 하단 기능들은 베타 버전으로 제공되고 있어 별도의 신청이 필요해요.<br/>
          <P/>
          ...
          베타테스터 등록을 원하신다면 <ContactMe/>
          (테스터 모집 인원이 가득 찼다면 등록이 불가능합니다.)
        </>),
      }, {
