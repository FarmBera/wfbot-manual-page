  ...
  troubleshooting: {
    ...
    list: [
      // 상호작용 오류
      {
        ...
        a: (
          <>
            데스크탑 및 웹 환경의 경우 Ctrl + R 키를 눌러서 디스코드 앱을
            새로고침 해주세요. (macOS 환경일 경우 cmd + R을 눌러주세요)
            <br />
            모바일 환경의 경우, 디스코드 앱을 종료했다가 다시 실행해주세요
          </>
        ),
      },
      // 파티에서 예고없이 탈퇴당함
      {
        ...
        a: (
          <>
            ...
            <br />
            닉네임 <strong>'고양이'</strong>를 가진 간부진(창설클랜 역할)에게
            DM으로 파티장의 닉네임과 상황을 설명해주세요. (대화 스크린샷
            첨부해주면 더욱 좋습니다.)
            <br />
