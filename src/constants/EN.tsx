...
export const uiTextsEn = {
    ...
    features: {
        ...
        head: (
            <P text="It provides real-time Warframe content updates and convenient utility features for your server."/>),
        items: [{
            ...
            title: "Market Search", desc: (<>
                ...
                You can easily search for item prices directly within Discord. No need to visit the Warframe Market
                website for
            ...
            title: "Server Trading System", desc: (<>
                ...
                It includes an automatic pricing feature based on real-time Market data, so even beginners can list
                items
    ...
    manual: {
        id: "manual", title: "3. Commands", mainTitle: "Command List", list: [{
            ...
            width: "50%",
            head: (<><P
                text="This command is under improvement. Some information might be displayed incorrectly."/></>),
        }, {
            id: SUB.CAMBIONCYCLE,
            title: "cambion-cycle",
            ...
            foot: (<div>
                <p className={htags.pTag}> For details, please refer to <strong>4. Party Recruitment</strong> in the
                    sidebar.
                </p>
            </div>),
        }, {
            ...
            foot: (<div>
                <p className={htags.pTag}> For details, please refer to <strong>5. Trading System</strong> in the
                    sidebar.</p>
            </div>),
        }, {
            id: SUB.EVENTS,
            ...
            id: "cmd-steel-incursion",
            title: "steelpath-incursion",
            desc: "Check today's Steel Path Incursions.",
            foot: (<>
            ...
            id: "cmd-arbitration", title: "arbitration", desc: "Check the current Arbitration mission type.", foot: (<>
                <DocImage src={`${IMG_PATH}arbitration${IMG_EXT}`} maxWidth="50%"
                          caption="/arbitration command example"/>
            </>),
        ...
        id: "party", title: "4. Party Recruitment", mainTitle: "Party Commands", list: [// Party Overview
            {
                ...
                foot: (<div>
                    <ul className={htags.ulTag}>
                        <li>If there is no activity (joins/leaves, status changes) for <strong>30 days</strong>, the
                            recruitment
                            will <strong>automatically end</strong>.
                        </li>
                        <li>Information entered when creating/editing a party is public. <strong>Do not enter sensitive
                            personal
                            information.</strong></li>
                        <li><strong>Server rules apply.</strong> Inappropriate language will result in automatic
                            deletion and
                    ...
                    <ul className={htags.ulTag}>
                        ...
                        <li>In serious cases, an immediate permanent ban may be issued with the consensus of the
                            administration.
                        </li>
                    </ul>
                ...
                desc: "How to check created party listings.",
                foot: (<>
                    <p className={htags.pTag}>
                ...
                id: "party-join-leave", title: "(2) Joining/Leaving", desc: "How to join or leave a party.", foot: (<>
                    ...
                    <p className={htags.pTag}>
                        Click the green <span className={`${tw.txt.green} font-extrabold`}>Join</span> button to join
                        the party.</p>
                    ...
                    <p className={htags.pTag}> Click the red <span
                        className={`${tw.txt.red} font-extrabold`}>Leave</span> button
                        to leave the party.</p>
                </>),
            }, {
                id: "party-how-create",
                title: "(3) Creating a Party",
                desc: "How to create a recruitment post.",
                foot: (<>
                    ...
                    <ul className={htags.ulTag}>
                        ...
                        <li><span className={htags.graveTag}>game_name</span>: Name of the game (Warframe, LoL, Apex,
                            etc.)
                        </li>
                        <li>[Optional] <span className={htags.graveTag}>start_time</span>: When the party starts
                            (Default: TBD)
                        </li>
                        <li>[Optional] <span className={htags.graveTag}>member_count</span>: Total number of members
                        </li>
                        <ul className={htags.ulTag}>
                        ...
                        <li>[Optional] <span className={htags.graveTag}>description</span>: Detailed description,
                            requirements, etc.
                        </li>
                    </ul>
                    <h4 className={htags.H4}>Fill in the desired information.</h4>
                    (Guides appear above the fields to help you)
                    <DocImage src={`${IMG_PATH}party-cmd-input${IMG_EXT}`} maxWidth="100%"
                    ...
                    <DocImage src={`${IMG_PATH}party-created${IMG_EXT}`} maxWidth="80%"
                              caption="Creation completion message"/>
                    Click the blue link to jump directly to your post, or go to the channel manually.
                    <DocImage src={`${IMG_PATH}party-created2${IMG_EXT}`} maxWidth="80%"
                              caption="Created Party Thread"/>
                </>),
            }, {
                id: "party-edit",
                ...
                id: "party-edit-member", title: "(4-1) Edit Capacity", foot: (<>
                    <p className={htags.pTag}><BOLD text="Edit Capacity"/> button allows you to change the max number of
                        members.
                    </p>
                    <ul className={htags.ulTag}>
                        <li>Includes <strong>the leader (you)</strong>.</li>
                    ...
                    <p className={htags.pTag}> Enter the new number and click <strong
                        className={`${tw.txt.sky}`}>Submit</strong>.
                    </p>
                ...
                foot: (<>
                    ...
                    <p className={htags.pTag}>Usage examples: "We are starting now!", "Check this announcement",
                        etc.</p>
                ...
                foot: (<>
                    <NOTE color="red" icon="alert" title="Warning" text={<div>
                        <div className={htags.pTag}><strong>
                            This feature is intended for situations where a member cannot attend but forgets to leave
                            the party
                            themselves.
                        </strong></div>
                        <div className={htags.pTag}><strong className={tw.txt.red}>Do not use this to kick members
                            without notice or
                            reason.</strong>
                        </div>
                ...
                foot: (<>
                    ...
                    <p className={htags.pTag}>Clicking <strong>Yes (Proceed)</strong> permanently ends the recruitment.
                    </p>
        ...
        id: "trade", title: "5. Trading System", mainTitle: "Trade Commands", list: [// trade warnings
            {
                ...
                foot: (<div>
                    {/* <NOTE color="yellow" icon="alert" title="Notice" ... /> */}
                    <ul className={htags.ulTag}>
                        <li>Trading is limited to <span className={tw.txt.yellow}>Warframe items only</span>. (No other
                            game items)
                        </li>
                        <li> All prices are based on <span className="font-bold">Real-time Warframe Market values</span>.
                        </li>
                        {/* detailed description */}
                        <ul className={htags.ulTag}>
                            <li>Listing items at <span className="font-extrabold">excessively</span> high prices to scam
                                users unaware
                                of market values is <span className={`${tw.txt.yellow}`}>strictly prohibited</span>.
                            </li>
                            <li>
                                To protect beginners, we provide a direct link to the <strong>Warframe
                                Market</strong> search results
                                for the listed item. (Click the <strong>blue link</strong> in the trade post).
                            </li>
                        </ul>
                        <li>
                            The currency does not necessarily have to be <span className="font-bold">[Platinum]</span>;
                            it is up to
                            the seller.
                        </li>
                        <ul className={htags.ulTag}>
                            <li>
                                ...
                                <span
                                    className={`${tw.txt.red} ${tw.bold.b}`}>(Immediate permanent ban if caught)</span>
                            </li>
                            <li>
                                According to the <A href="https://www.warframe.com/eula#virtualGoods"
                                                    text="Warframe EULA"/>{" "}
                ...
                id: "trade-request",
                title: "(1) Requesting a Trade",
                desc: "How to buy/trade for a listed item.",
                foot: (<>
                ...
                id: "trade-how-create", title: "(2) Creating a Trade Post", desc: "", foot: (<>
                    ...
                    <ul className={htags.ulTag}>
                        ...
                        <li><span className={htags.graveTag}>item_name</span>: Name of the item (Searchable from
                            Warframe Market
                            database)
                        </li>
                        <li>
                            <span className={htags.graveTag}>item_rank</span>: [Optional] Rank of the item (for
                            Mods/Arcanes).
                        </li>
                        <li><span className={htags.graveTag}>price</span>: [Optional] Price per unit.</li>
                        <ul className={htags.ulTag}>
                            <li> If left empty, it automatically sets a reasonable price based on the lowest Market
                                listing.
                            </li>
                        </ul>
                        <li><span className={htags.graveTag}>quantity</span>: [Optional] Number of items. (Default: 1)
                        </li>
                    </ul>
                    <P
                ...
                id: "trade-edit",
                title: "(3) Managing Trade Posts",
                desc: "Features available on the trade post.",
                foot: (<>
                ...
                id: "trade-exit", title: "(3-4) Close Trade", desc: "Mark the trade as complete/closed.", foot: (<>
                    ...
                    <p className={htags.pTag}>
                        Clicking <strong>Yes (Close)</strong> will archive the post. <br/> (It is not fully deleted from
                        the channel
                        history.)
                    </p>
        ...
        id: "faq", title: "FAQ / Troubleshooting", list: [// Interaction failed
            {
                q: `"This command is deprecated... try again later."`, a: (<>
                    <ul className={`${htags.ulTag} ${tw.txt.dim}`}>
                        <li>On Desktop/Web: Press <strong>Ctrl + R</strong> (or <strong>Cmd + R</strong> on macOS) to
                            reload
                            Discord.
                        </li>
            ...
            }, // Application did not respond
            {
                q: (<>
                    ...
                    <ul className={`${htags.olTag} ${tw.txt.dim}`}>
                        ...
                        <ul className={`${htags.ulTag} ${tw.txt.dim}`}>
                            <li>If the status says <strong>"Maintenance"</strong> with a Do Not Disturb icon, please
                                wait until
                                maintenance is over.
                            </li>
    ...
    terms: {
        id: "tos", title: "Terms of Service", desc: (<>
            ...
            <ul className={htags.ulTag}>
                ...
                <li>The Service may be modified or suspended due to maintenance, Discord API policy changes, or force
                    majeure.
                </li>
            ...
            <ul className={htags.ulTag}>
                <li>The Operator is not liable for service interruptions due to force majeure, game server maintenance,
                    or
                ...
                <li>The Trading features are tools for convenience. The actual transaction is the responsibility of the
                    users.
                </li>
                <ul className={htags.ulTag}>
                    ...
                    <li>The Operator is not liable for account penalties (bans) resulting from violations of the game's
                        EULA.
                    </li>
                </ul>
            </ul>
    ...
    privacy: {
        id: "privacy", title: "Privacy Policy", desc: (<>
            ...
            <ul className={htags.ulTag}>
                ...
                <li><strong>Environment Info</strong>: Server (Guild) Name/ID, Channel Name/ID where commands are used.
                </li>
            ...
            <ul className={htags.ulTag}>
                ...
                <li><strong>Service Termination</strong>: All data is destroyed upon the termination of the Service.
                </li>
            </ul>
            ...
            <ul className={htags.ulTag}>
                ...
                <li><strong>Method</strong>: Permanent deletion using technical methods that make recovery impossible.
                </li>
            </ul>
            ...
            <ol className={htags.ulTag}>
                ...
                <li><strong>Technical</strong>: Data encryption, encrypted communication, and regular security updates.
                </li>
            </ol>
    ...
    legal: {
        id: "legal", title: "Legal & Copyright", desc: (<>
            ...
            <p><strong>Warframe©</strong> is a registered trademark of Digital Extremes Ltd.
                Images and content used in this service are for informational purposes only, with no intent to infringe
                on
                copyright.
            </p>
            ...
            <p>This service is an <strong>Unofficial</strong> project created by a fan.
                <strong>'{COMMON.nameEn}'</strong> is not affiliated with, endorsed, sponsored, or approved by Digital
                Extremes
                Ltd.
