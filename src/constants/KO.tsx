    ...
    intro: {
        ...
        id: "tos", title: "이용 약관", desc: (<>
            ...
            <ul className={htags.ulTag}>
                ...
                <ul className={htags.ulTag}>
                    <li>서비스를 통해 이루어지는 사용자 간의 거래는 전적으로 사용자의 판단과 책임하에 이루어집니다.</li>
            ...
            <P text="본 서비스는 만 19세 이상을 대상으로 합니다. 만 19세 미만의 아동은 서비스를 이용할 수 없으며, 해당 사실이 확인될 경우 서비스 이용이 제한될 수 있습니다."/>
        ...
        id: "contact", title: "도움이 필요하신가요?", foot: (<>
            ...
            <ul className={htags.ulTag}>
                ...
                <li>
                    별도의 <A href={import.meta.env.VITE_SUPPORT_SERVER} text="디스코드 지원 서버"/>에 접수 <br/>
