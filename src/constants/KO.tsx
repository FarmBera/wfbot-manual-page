...
export const uiTextsKo = {
        ...
        id: "party", title: "4. 파티 모집 기능", mainTitle: "파티 모집 명령어", list: [// 파티 기능 개요
            {
                ...
                id: "party-list", title: "(1) 파티 정보 확인하기", desc: "생성된 파티 정보를 확인하는 방법", foot: (<>
                    <p className={htags.pTag}>
                        <strong className={tw.txt.sky}>일상채널</strong> 카테고리의 <strong
                        className={tw.txt.sky}>파티모집</strong> 채널로 이동하면
                ...
                id: "party-edit-member", title: "(4-1) 인원 수정", foot: (<>
                    ...
                    <p className={htags.pTag}> 원하는 인원수를 입력하고 <strong className={`${tw.txt.sky}`}>전송</strong>을 눌러주세요.
                    </p>
                ...
                id: "party-edit-article", title: "(4-2) 게시글 수정", desc: "잘못 입력한 내용을 수정하기 위한 기능입니다.", foot: (<>
                    ...
                    <p className={htags.pTag}>
                        수정하고자 하는 항목을 수정 후 <strong className={`${tw.txt.sky} ${tw.bold.eb}`}>전송</strong> 버튼을 누르면 항목이
                        수정됩니다.
                    </p>
                ...
                id: "party-kick", title: "(4-6) 파티원 내보내기", desc: "특정 파티원을 선택하여 강제로 내보냅니다.", foot: (<>
                    <NOTE color="red" icon="alert" title="주의사항" text={<div>
                        ...
                        <div className={htags.pTag}><strong className={tw.txt.red}>파티원을 예고도 없이 강제로 내보내는 등 부적절한 사용은
                            금합니다.</strong>
                        </div>
                    ...
                    <p className={htags.pTag}><strong>내보낼 파티원을 선택하세요</strong>(드롭다운 메뉴)를 클릭하면 내보내고자 하는 파티원을 선택할 수 있습니다.
                    </p>
    ...
    terms: {
        id: "tos", title: "이용 약관", desc: (<>
            ...
            <H2 text="책임의 제한 (면책)"/>
            <ul className={htags.ulTag}>
                <li>운영자는 천재지변, 게임사의 서버 점검, 디스코드 플랫폼의 장애, 통신망의 장애, 또는 이에 준하는 불가항력으로 인해 서비스를 제공할 수 없는 경우에 대해 책임을 지지
                    않습니다.
                </li>
                <li>운영자는 사용자의 귀책 사유로 인한 서비스 이용의 장애나 데이터 손실에 대해 책임을 지지 않습니다.</li>
                <li>운영자는 사용자가 서비스를 이용하여 기대하는 수익을 상실하거나, 서비스를 통해 얻은 자료로 인해 발생한 손해에 대해 운영자의 고의 또는 중대 과실이 없는 한 책임을 지지
                    않습니다.
                </li>
